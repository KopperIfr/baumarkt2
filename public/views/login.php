<div class="min-h-[46rem] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-center text-sm text-gray-600 max-w">
            oder
            <a href="/baumarkt2/register" class="font-medium text-blue-600 hover:text-blue-500">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 border-[.01rem] border-black/10 shadow sm:rounded-lg sm:px-10">
            <form class="space-y-6" action="/baumarkt2/login" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="email" name="user[email]" type="email" autocomplete="email" required
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="password" name="user[pwd]" type="password" autocomplete="current-password" required
                            class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
